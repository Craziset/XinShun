...
@interface PassengerViewController ()<NewPagedFlowViewDelegate, NewPagedFlowViewDataSource,GYChangeTextViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>
{
...
- (void)viewDidLoad {
    ...
    tView.layer.borderColor = [UIColor lightGrayColor].CGColor;
    [self.msgView addSubview:tView];
    self.tView = tView;
    [self.tView animationWithTexts:[NSArray arrayWithObjects:@"这是第1条",@"这是第2条",@"这是第3条", nil]];


    collectionViewCellTipAry =[[NSArray alloc]initWithObjects:@"发布行程",@"结伴出行",@"我的行程",@"我的信息",@"我的钱包",@"更多", nil];
...
- (void)setupUI {
    ...
    NewPagedFlowView *pageFlowView = [[NewPagedFlowView alloc] initWithFrame:CGRectMake(0, -30, Width, (Width - 84) * 9 / 16 + 24)];
    ...
    [self.ScroContentView addSubview:bottomScrollView];
